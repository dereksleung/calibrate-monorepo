...
- 2026-09-06: Ticket 01's cold-start session-loss catch block performs one best-effort revocation; this ticket must record the durable `server-logout-confirmed` marker before advancing the fence with bounded retries.
