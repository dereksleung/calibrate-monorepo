...
Matt Pocock skills speak in terms of five canonical triage roles. This file maps those roles to the actual status strings used in this repo's issue tracker.

Only consume or edit these statuses when using a skill that comes from Matt Pocock, as identified in each skill's `skills.md` file.
