...
import { doesDayLogRangeNeedValidation, getDayLogsWithStalenessState } from "#/verticals/day-log-cache/day-log-cache.ts";
import { useSyncDayLogsForDateRange } from "#/verticals/day-log-cache/use-sync-day-logs-for-date-range.ts";
import { updateDayLogWeightAndReconcile } from "@calibrate/frontend-core/feature-workflows/day-logs/update-day-log-weight";
...
export function Logs({ selectedDate, todayDate = getTodayDateString() }: LogsProps) {
  ...
  async function saveWeight(weight: number) {
    await updateDayLogWeightAndReconcile(apiTransport, queryClient, accountId, selectedDate, weight);
  }
