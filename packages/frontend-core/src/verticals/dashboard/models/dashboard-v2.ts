import type { DayLogSnapshot } from "../../day-logs/models/day-log.js";
import type { DayLog, FoodEntry } from "../../day-logs/models/day-log.js";
...
export function buildDashboardV2ViewModel({
  ...
  const endDate =
    endDateInput ?? endDateFromSlotQueries(initialSevenDayData) ?? sevenDayHistory[sevenDayHistory.length - 1]?.date ?? "";
